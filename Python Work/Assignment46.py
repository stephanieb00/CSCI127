#Stephanie Bravo
#April 3, 2019
#This prgram will modify averageimage.py

import numpy as np
import matplotlib.pyplot as plt

def average(region):
    #Takes a region of an image and returns the average red,
    #green, and blue values across the region.
...
def setRegion(region, r,g,b):
     ...
     """
     #Takes a region of an image and red, green, and blue values, r, g, b.
     #Sets the region so that
     #all points have red values of r, green values of g, and blue values of b.
     region[:, :, 0] = r
     region[:, :, 1] = g
     region[:, :, 2] = b
######################################################################
